...
Radiation_12 = pd.read_excel('GUTIERREZ RAD SOLAR  2013.xlsx')
Temperature_12 = pd.read_excel('GUTIERREZ TEMP  2013.xlsx')
...
slop = pd.read_excel('Slop_Thesis.xls')
