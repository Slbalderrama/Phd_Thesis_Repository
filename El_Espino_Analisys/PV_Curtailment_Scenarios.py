...
scatter_plot['PV Temperature 2'] =X_3['PV Temperature 2']
scatter_plot['Solar Irradiation'] = X_3['Solar Irradiation']
scatter_plot['Efficiency'] = y_3['Efficiency']*100
scatter_plot_2 = scatter_plot.sample(5000, random_state=10)
