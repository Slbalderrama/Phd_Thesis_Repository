...
village = [100,300, 500] #range(50, 570, 50)
...
for i in village:
 ...
 #75   
    for n in range(Nruns):
        ...
        print(n)
        start_1 =  time.time()
        location = Data_Villages.loc[197]
        ...
        Status.loc[name, 'X_deg'] = location['X_deg']
        Status.loc[name, 'Y_deg'] = location['Y_deg']
        # Renewable energy parameters
        ...
        Fuel_Cost_1 = round(Fuel_Cost_1,3)
