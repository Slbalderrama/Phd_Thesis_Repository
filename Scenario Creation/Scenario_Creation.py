...
for i in index:
    if (Power_Data_2['PV Power'][i] > 0 and 
        ...
        test1.loc[i,'PV Power'] = Power_Data_2['PV Power'][i]
        test1.loc[i,'Irradiation 2'] = Power_Data_3['Irradiation 2'][i]
...
# Due to the low values of the PV output where irradiation is 0, I will not change it.
# this values will desapear when analyzing one PV.   
