...
Results.loc['grid','NPC'] =  round(grid_solution['NPC2025'].sum()/1000000,1)

print('The total NPC of the grid is ' + str(Results.loc['grid','NPC'])+ 
      ' thousands of millons of USD.')

Results.loc['microgrid','NPC'] =  round(microgrids_solution['NPC2025'].sum()/1000000,1)

print('The total NPC of the microgrid is ' + str(Results.loc['microgrid','NPC']) + 
      ' thousands of millons of USD.')

Results.loc['SHS','NPC'] =  round(SHS_solution['NPC2025'].sum()/1000000,1)
...
Results.loc['grid','Capacity'] =  round(grid_solution['NewCapacity2025'].sum()/1000,0)

print('The total new installed capacity of the grid is ' + str(Results.loc['grid','Capacity'])+ 
      '.')

Results.loc['microgrid','Capacity'] =  round(microgrids_solution['NewCapacity2025'].sum()/1000,0)

print('TThe total new installed capacity of the microgrid is ' + str(Results.loc['microgrid','Capacity']) + 
      '.')

Results.loc['SHS','Capacity'] =  round(SHS_solution['NewCapacity2025'].sum()/1000,0)
