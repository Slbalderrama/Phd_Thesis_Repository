...
print('The average LCOE for grid communities is ' +str(lcoe_pv) + ' USD/kWh')

lcoe_diesel = round(microgrids_diesel['MinimumOverallLCOE2025'].mean(),2) 

print('The average LCOE for grid communities is ' +str(lcoe_diesel ) + ' USD/kWh')
...
df_2012.to_csv('Unconnected_2012_results.csv')
...
# 2022-02-04 16:27:46,663         Electrification loop 1 with 11993 electrified
# 2022-02-04 16:27:46,790         Electrification loop 2 with 54 electrified
# 2022-02-04 16:27:46,903         Electrification loop 3 with 9 electrified
# 2022-02-04 16:27:47,014         Electrification loop 4 with 1 electrified