...
def input_file(k):
    ...
    HI = User("high income",20*k,3)
    User_list.append(HI)
    
    LI = User("low income",30*k,3)
    User_list.append(LI)
    
    Public_lighting = User("public lighting",1*k)
