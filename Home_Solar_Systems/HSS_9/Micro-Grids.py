...
Lost_Load_Probability  =  0.9  # Allowed percentage of unmed demand in the system
...
#Renewable 1 nominal capacity is 0.0 kW
#Generator 1 nominal capacity is 0.0 kW
#Battery nominal capacity is 0.0 kWh
#NPC is 0.0 Thousand USD
#The LCOE is 0.011 USD/kWh
#100.0 % Renewable Penetration
#16.0 % of energy curtail
#0.8 % Battery usage
#90.0 % Lost load in the system
#The optimization took 314.0 seconds